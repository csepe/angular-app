...
export class MapService {
  ...
  initMap(gmapElement, mapOptions) {
  ...
  findClosestMarkers(event, n) {
    ...
    return markers_distances.sort((a, b) => { return a.distance - b.distance }).slice(0, n);
  }
  ...
  setCustomMapLayers(layers) {
    layers.forEach(customTile => {
      if (customTile.url) {
